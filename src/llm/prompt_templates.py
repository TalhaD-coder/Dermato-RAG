...
6. Bu sistemin yaklaşık %73 top-1 / ~%87 top-3 doğrulukla çalıştığını; nihai tanı için
...
5. Instead of "the definitive diagnosis is", use phrasing like "based on the evidence the most
   likely findings are".
6. Explicitly state in every report that this system operates at ~73% top-1 / ~87% top-3
...
Bu tanı raporu, BiomedCLIP tabanlı görüntü analizi (%73 top-1 / ~%87 top-3 doğruluk) ve
...
(~73% top-1 / ~87% top-3 accuracy) and PubMed literature synthesis.
